...
rules = [
    ...
    ExactCopyRule("All numeric digits must match in order", r"(?<!\#)\d+(?!rd)(?!-step)(?!-digit)(?!-stellig)(?!-stellige)(?!-stelligen)(?!\. )", severity=Severity.dangerous, aliases=imageAliases), # Avoid image URLs matching
