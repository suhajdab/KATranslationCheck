...
rules = [
    ...
    SimpleRegexRule("Occurrence of untranslated 'converges'", r"\b[Cc]onverges\b", severity=Severity.standard),
    SimpleRegexRule("Occurrence of untranslated 'diverges'", r"\b[Dd]iverges\b", severity=Severity.standard),
    ...
    SimpleRegexRule("Occurrence of untranslated 'infinity", r"\b[Ii]nfinit[ey]\b", severity=Severity.standard),
    ...
    TranslationConstraintRule("'dilation' not translated to 'Streckung'", r"dilation", r"(streckung|gestreckt)", severity=Severity.info, flags=re.UNICODE | re.IGNORECASE),
    ...
    TranslationConstraintRule("'vertical angle' not translated to 'Scheitelwinkel'", r"vertical\s+angle", r"Scheitelwinkels?", severity=Severity.standard, flags=re.UNICODE | re.IGNORECASE),
